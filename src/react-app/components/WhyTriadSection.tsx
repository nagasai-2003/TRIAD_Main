...
export default function WhyTriadSection() {
  ...
  return (
    <section className="py-20 bg-arctic-white" aria-labelledby="why-triad-heading">
      <div className="max-w-6xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16 fade-in">
          <h2 id="why-triad-heading" className="font-montserrat font-bold text-4xl md:text-5xl text-steel-navy mb-6">
            Why Choose TRIAD?
          </h2>
