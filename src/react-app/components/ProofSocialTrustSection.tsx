...
/**
 * A section designed to build social proof and trust.
 * It showcases student testimonials, key statistics, and logos of trusted partners.
 */
export default function ProofSocialTrustSection() {

  // Memoized data for testimonials to prevent re-creation on every render.
  ...
  // Memoized data for key statistics.
  const stats = useMemo(() => [
    {
  ...
  return (
    <section 
      ...
      aria-labelledby="social-trust-heading"
    >
      <div className="max-w-6xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16 fade-in">
          <h2 
            id="social-trust-heading" 
        ...
        >
          <p id="trust-heading" className="font-inter text-charcoal-gray/60 mb-6">
            Our graduates are trusted by top companies worldwide
          </p>
